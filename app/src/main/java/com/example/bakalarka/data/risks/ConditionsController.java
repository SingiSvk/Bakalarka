...
public class ConditionsController {
    ...
    public String createNotification(@NonNull Notification notification, @NonNull Map<String, Integer> risks, int roomId){
        ...
        if (highRisk){
            notificationController.showNotification(notification, ConditionsController.HIGH, roomId);
            return message;
        }else if (lowRisk){
            notificationController.showNotification(notification, ConditionsController.LOW, roomId);
            return message;
        }else{
            return "0";
        }
