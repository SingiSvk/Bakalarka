...
public class Conditions {
    ...
    public static final float HIGH_HUM = 50;
    public static final float IDEAL_HUM = 30;
    public static final float LOW_HUM = 20;
    public static final float MIN_HUM = 10;
    public static final float MAX_VOC = 400;
    public static final float HIGH_VOC = 350;
    public static final float IDEAL_VOC = 100;
    public static final float LOW_VOC = 0;
    public static final float MIN_VOC = 0;
